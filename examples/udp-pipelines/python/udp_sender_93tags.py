...
and streams the multiplexed MPEG-TS output over UDP.
...
def run_sender(
    ...
    """Run UDP sender with randomized KLV tags."""
    ...
    print("\n" + "=" * 100)
    print("UDP SENDER - MISB ST 0601.8 KLV TAGS")
    print("=" * 100 + "\n")
    print("> Configuration:")
    print(f"  Destination Host: {host}")
    print(f"  Port: {port}")
...
def main():
    parser = argparse.ArgumentParser(
        description="UDP Sender with MISB ST 0601.8 KLV tags"
    )
